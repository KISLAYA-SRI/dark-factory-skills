...
- The Sonar MCP tool or equivalent tooling is configured and accessible.
...
1. Fetch all unresolved issues for the current analysis using the Sonar MCP tool.
2. Group issues by dimension and severity.
3. Load the relevant dimension reference files.
4. Apply fixes dimension by dimension, prioritizing BLOCKER and CRITICAL.
...
1. Skip the Sonar MCP fetch step.
